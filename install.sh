...
PDV_STATION=$PDV_STATION
PDV_BASE_DIR=$PDV_BASE_DIR
AUDITOR_ROI=$AUDITOR_ROI
AUDITOR_OUTDIR=/var/log/pdv-camera-auditor
AUDITOR_DURATION=0
AUDITOR_SPY_TAIL=350
AUDITOR_THRESHOLD=9.0
AUDITOR_WINDOW=5.0
AUDITOR_ITEM_BEFORE=20.0
AUDITOR_ITEM_AFTER=35.0
AUDITOR_MATCH_DELAY=4.0
AUDITOR_PENDING_DELAY=30.0
AUDITOR_SUSPECT_COOLDOWN=90.0
AUDITOR_SUSPECT_MIN_SCORE=24.0
AUDITOR_SUSPECT_MIN_MOVES=4
AUDITOR_SUSPECT_MIN_DURATION=3.0
AUDITOR_SKIN_IGNORE_RATIO=0.12
AUDITOR_CONSULTATION_WINDOW=45.0
AUDITOR_CLUSTER_GAP=3.0
